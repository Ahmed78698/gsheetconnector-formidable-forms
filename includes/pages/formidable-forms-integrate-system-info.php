...
$frm_free_system_log = new Gsheetconnector_For_Formidable_Forms();
?>;
<div class="system-statuswc">
	<div class="info-container">
		<h2 class="system-info"><?php esc_html_e( 'System Info', 'gsheetconnector-for-formidable-forms' ); ?></h2>
		<button onclick="copySystemInfo()" class="copy"><?php esc_html_e( 'Copy System Info to Clipboard', 'gsheetconnector-for-formidable-forms' ); ?></button>
		<?php 
		/* phpcs:disable */
		echo wp_kses_post( $frm_free_system_log->get_frmforms_system_info() );
		/* phpcs:enable */
		 ?>
	</div>
</div>
...
<div class="system-error">
	<div class="error-container">
		<h2 class="system-error"><?php esc_html_e( 'Error Log', 'gsheetconnector-for-formidable-forms' ); ?></h2>
		<p>
			<?php esc_html_e( 'If you have', 'gsheetconnector-for-formidable-forms' ); ?>
			<a href="https://www.gsheetconnector.com/how-to-enable-debugging-in-wordpress" target="_blank">
				<?php esc_html_e( 'WP_DEBUG_LOG', 'gsheetconnector-for-formidable-forms' ); ?>
			</a>
			<?php esc_html_e( 'enabled, errors are stored in a log file. Here you can find the last 100 lines in reversed order so that you or the GSheetConnector support team can view it easily. The file cannot be edited here.', 'gsheetconnector-for-formidable-forms' ); ?>
		</p>
		<button onclick="copyErrorLog()" class="copy"><?php esc_html_e( 'Copy Error Log to Clipboard', 'gsheetconnector-for-formidable-forms' ); ?></button>
		<button class="clear-content-logs-frm"><?php esc_html_e( 'Clear', 'gsheetconnector-for-formidable-forms' ); ?></button>
		<span class="clear-loading-sign-logs-frm">&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;</span>
		<div class="clear-content-logs-msg-frm"></div>
		<input type="hidden" name="gs-ajax-nonce" id="gs-ajax-nonce" value="<?php echo esc_attr( wp_create_nonce( 'gs-ajax-nonce' ) ); ?>" />
		<div class="copy-message" style="display: none;"><?php esc_html_e( 'Copied', 'gsheetconnector-for-formidable-forms' ); ?></div> <!-- Add a hidden div for the copy message -->
		<?php
		/* phpcs:disable */
		echo wp_kses_post( $frm_free_system_log->display_error_log() );
		/* phpcs:enable */
		?>
	</div>
</div>
...
.clear-content-logs-msg-frm{
	font-size: 14px;
	font-weight: bold;
	color: green;
}
/* Style for the "Clear" button */
.clear-content-logs-frm {
	margin: 1rem 0;
	display: inline-flex;
	align-items: center;
